...
<body class="bg-gray-100 font-sans antialiased">
    <header class="max-w-5xl mx-auto px-4 pt-8">
        ...
        <p class="text-gray-600">Vyber člena týmu a klikni do kalendáře pro zápis. Klik na existující záznam = editace.</p>
    </header>
    ...
    <main class="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        <dialog id="attendanceDialog" class="rounded-2xl p-0 w-full max-w-lg">
            <form id="attendanceForm" method="post" action="{{ route('attendance.store') }}" class="p-6 space-y-4">
                @csrf
                ...
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p id="dialogHint" class="text-xs text-gray-500 mt-1">
                            Vyplň aktivitu a ulož. (Při kliknutí na záznam se přepneš do editace.)
                        </p>
                    </div>
                ...
                <div class="flex justify-between items-center gap-2 pt-2">
                    {{-- ✅ smaže záznam (jen v editaci) --}}
                    <button type="button" id="deleteAttendance"
                        class="px-4 py-2 rounded-xl border border-red-200 bg-red-50 text-red-700 font-semibold hidden">
                        Smazat
                    </button>

                    <div class="flex justify-end gap-2">
                        <button type="submit" class="px-4 py-2 rounded-xl bg-blue-600 text-white font-semibold">
                            Uložit
                        </button>
                    </div>
                </div>
                ...
                <p class="text-xs text-gray-500">
                    Pozn.: Ukládání probíhá přes fetch (bez reloadu), takže pokud něco spadne, mrkni do Console.
                </p>
            </form>
        </dialog>
    </main>
